...
export const ControlPointEditorPanel: Component<{ pid: string, controlPoint: () => ControlPointModel | undefined, onChange: (newControlPoint: ControlPointModel) => void }> = (props) => {
